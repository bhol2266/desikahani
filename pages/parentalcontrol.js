...
function parentalcontrol() {
    return (
        ...
        <div className="m-2 border-2 border-gray-200 p-2">
            ...
            <h1 className="header">DesiKahaniya is rated with RTA label</h1>
            ...
            <p className="para">DesiKahaniya is a proud member of the RTA rating system, and we registered our website quite a while ago. Our site, DesiKahaniya, has an RTA code: RTA-5042-1996-1400-1577-RTA</p>
